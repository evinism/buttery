...
export const gen: CodeGenerator = (file) => {
  ...
  const content = `import {structNode, listNode, booleanNode, integerNode, doubleNode, stringNode, nullNode, optionalNode, oneOfNode, mapNode} from 'buttery-node/dist/shared/nodes';
