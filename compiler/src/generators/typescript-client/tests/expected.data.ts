import {ButterClient, structNode, listNode, booleanNode, integerNode, doubleNode, stringNode, nullNode, buildRpcHandler, buildChannelHandler} from './butter.runtime';
...
export class PartyServiceClient extends ButterClient {
